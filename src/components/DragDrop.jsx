...
const DragDrop = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute bg-green-800">
        <div className="w-full flex justify-center  space-x-4 mt-8 object-cover">
          <div
            className={`${isMobile ? "w-[40%]" : "w-[70%]"} mx-auto relative`}
          >
            <CustomCarousel
              images={images.filter((img) => img.type === "food")}
            />
          </div>
        </div>
        ...
        <div className="w-full flex justify-center mt-10 space-x-4 ">
          ...
          >
            <CustomCarousel
              images={images.filter((img) => img.type === "exercise")}
            />
          </div>
        </div>
        <ProgressBar
